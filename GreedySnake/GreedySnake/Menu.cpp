...
void Menu::Selection(TextRenderer &text, GLuint &width, GLuint &height) {
	...
	text.RenderText("Just watching AI how to make it.", 230.0f, height / 2 - 40.0f, 1.0f);
...
void Menu::Win(TextRenderer &text, GLuint &width, GLuint &height) {
	text.RenderText(
		"Congratulation!!!", 310.0f, height / 2 - 20.0, 1.0, glm::vec3(1.0, 1.0, 0.0)
	);
	text.RenderText(
		"AI got all of them!!!", 300.0f, height / 2, 1.0, glm::vec3(1.0, 1.0, 0.0)
	);
	text.RenderText(
